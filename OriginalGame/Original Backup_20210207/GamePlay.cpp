...
const int BLOCK_OBJECT_COUNT = 100;
...
int g_score = 0;
int digit = 1;
const float SCORE_SIZE_X = 80.0f;
const float SCORE_SIZE_Y = 112.0f;
...
void COriginalGameApp::procPlayBegin()
{
	...
	if (Stage == eStage2) {
		//	g_enemyObjs[eWalk][0].beginPos = PosFromLeftTop(3.0f, 10.0f);
	...
	if (Stage == eStage4) {
		...
		g_enemyObjs[eSpring][0].beginPos = PosFromLeftTop(8.0f, 5.0f);
		g_enemyObjs[eFly][0].beginPos = PosFromLeftTop(9.0f, 8.0f);
		g_enemyObjs[eFly][1].beginPos = PosFromLeftTop(17.5f, 5.0f);
	}
	if (Stage == eStagefinal) {
		g_enemyObjs[eWalk][0].beginPos = PosFromLeftTop(10.0f, 1.0f);
		g_enemyObjs[eWalk][1].beginPos = PosFromLeftTop(13.0f, 1.0f);
		g_enemyObjs[eWalk][2].beginPos = PosFromLeftTop(15.0f, 1.0f);
	}
	...
	if (Stage == eStage4) {
		...
		//g_blockObjs[5].beginPos = PosFromLeftTop(6.0f, 7.0f);
		//g_blockObjs[6].beginPos = PosFromLeftTop(6.0f, 8.0f);
		//g_blockObjs[7].beginPos = PosFromLeftTop(6.0f, 9.0f);
		//g_blockObjs[8].beginPos = PosFromLeftTop(6.0f, 10.0f);
		//g_blockObjs[9].beginPos = PosFromLeftTop(6.0f, 11.0f);
		//g_blockObjs[10].beginPos = PosFromLeftTop(6.0f, 12.0f);
		//g_blockObjs[11].beginPos = PosFromLeftTop(6.0f, 12.0f);
		g_blockObjs[12].beginPos = PosFromLeftTop(7.0f, 12.0f);
		g_blockObjs[13].beginPos = PosFromLeftTop(8.0f, 12.0f);
		g_blockObjs[14].beginPos = PosFromLeftTop(9.0f, 12.0f);
		g_blockObjs[15].beginPos = PosFromLeftTop(10.0f, 12.0f);
		//g_blockObjs[16].beginPos = PosFromLeftTop(11.0f, 12.0f);
		g_blockObjs[17].beginPos = PosFromLeftTop(12.0f, 12.0f);
		g_blockObjs[18].beginPos = PosFromLeftTop(12.0f, 11.0f);
		g_blockObjs[19].beginPos = PosFromLeftTop(12.0f, 10.0f);
		g_blockObjs[20].beginPos = PosFromLeftTop(12.0f, 9.0f);
		g_blockObjs[21].beginPos = PosFromLeftTop(12.0f, 8.0f);
		g_blockObjs[22].beginPos = PosFromLeftTop(12.0f, 7.0f);
		g_blockObjs[23].beginPos = PosFromLeftTop(12.0f, 6.0f);
		g_blockObjs[24].beginPos = PosFromLeftTop(12.0f, 5.0f);
		//g_blockObjs[25].beginPos = PosFromLeftTop(12.0f, 4.0f);
		//g_blockObjs[26].beginPos = PosFromLeftTop(21.0f, 7.0f);
		//g_blockObjs[27].beginPos = PosFromLeftTop(24.0f, 12.0f);
		g_blockObjs[28].beginPos = PosFromLeftTop(23.0f, 9.0f);
		g_blockObjs[29].beginPos = PosFromLeftTop(22.0f, 9.0f);
		g_blockObjs[30].beginPos = PosFromLeftTop(21.0f, 9.0f);
		g_blockObjs[31].beginPos = PosFromLeftTop(21.0f, 8.0f);
		g_blockObjs[32].beginPos = PosFromLeftTop(21.0f, 7.0f);
		g_blockObjs[33].beginPos = PosFromLeftTop(21.0f, 6.0f);
		/*g_blockObjs[34].beginPos = PosFromLeftTop(20.0f, 11.0f);
		g_blockObjs[35].beginPos = PosFromLeftTop(20.0f, 10.0f);
		g_blockObjs[36].beginPos = PosFromLeftTop(20.0f, 9.0f);*/
	}
	if (Stage == eStagefinal) {
		for (int i = 0; i < BLOCK_OBJECT_COUNT; ++i) {
			static int y = 5;
			...
			g_blockObjs[i].beginPos = PosFromLeftTop((float)(i % 30 + 1), (float)y);
		}
	}
	for (int i = 0; i < BLOCK_OBJECT_COUNT; ++i) {
	...
	if (Stage == eStagefinal) {
		g_pPlayer->setPos(PosFromLeftTop(1.0f, 1.0f));
	}
	if (Stage == eStage4) {
		g_pPlayer->setPos(PosFromLeftTop(12.0f, 3.0f));
	}
	...
	if (Stage == eStage1) {
		...
		//g_air[1].beginPos = PosFromLeftTop(17.0f, 12.0f);
		//g_air[2].beginPos = PosFromLeftTop(17.0f, 12.0f);
		//g_air[3].beginPos = PosF r omLeftTop(17.0f, 12.0f);
	}
	if (Stage == eStage4) {
...
void COriginalGameApp::procPlayMain_score()
{
	...
	if (g_pScore == NULL)
	{
		...
		g_pScore->setPos(-SCORE_SIZE_X * (float)digit, -(WINDOW_HEIGHT - SCORE_SIZE_Y) / 2 + 30.0f);
	}
